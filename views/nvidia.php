...
<h1 class="text-center pt-5 my-5">Productos Nvidia GeForce</h1>
<div class="container">
    <div class="row mb-5">
                        ...
                        <div class="card nvidia-card m-2" style="width: 20rem;">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><strong>Cant. memoria:</strong> <?= $placa->getMemoria() ?></li>
